...
import { StlyedChip, StyledButton, StyledSmallSvgIcon, StyledSvgIcon, StyledTextField, StyledTypography } from "./profileStyles";
  ...
  return (
    <Box padding={2} marginLeft={2}>
      ...
      <Box display='flex' justifyContent='right' marginRight={8}>
        <Box display='flex'>
          <StyledButton variant="outlined">
            <StyledSmallSvgIcon>
              <image href="Edit.svg" width="100%" height="100%" />
            </StyledSmallSvgIcon>
            &nbsp;
            Edit
          </StyledButton>
      ...
      <Box display='flex' gap={8}>
        <Box display='flex' flexDirection='column' gap={3} width={500}>
          ...
          <Box>
              ...
              <Box padding={2} border='1px solid #000000' borderRadius={2} height={110}>
            ...
            <Box>
              ...
              <Box display='flex' flexDirection='column' gap={2}>
                <Box display='flex' alignItems='center' gap={1}>
                  <StyledSvgIcon>
                    <image href="Location.svg" width="100%" height="100%" />
                  </StyledSvgIcon>
            ...
            <Box>
              <Typography variant="subtitle1" marginBottom={1} fontWeight='bold'>Websites</Typography>
              <Box display='flex' alignItems='center' gap={1}>
                <StyledSvgIcon>
                  <image href="Website.svg" width="100%" height="100%" />
                </StyledSvgIcon>
        ...
        <Box>
          <Box>
            <Typography variant="subtitle1" marginBottom={1} fontWeight='bold'>Brand Logo</Typography>
          ...
          <Box sx={{ mt: 4 }}>
            <Typography variant="subtitle1" marginBottom={1} fontWeight='bold'>Contacts</Typography>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <StyledSvgIcon>
                  <image href="Contact.svg" width="100%" height="100%" />
                </StyledSvgIcon>
          ...
          <Box sx={{ mt: 4 }}>
            <Typography variant="subtitle1" marginBottom={1} fontWeight='bold'>Socials</Typography>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <StyledSvgIcon>
                <image href="Instagram.svg" width="100%" height="100%" />
              </StyledSvgIcon>
      ...
      <Box width='95%' marginTop={2}>
        <StyledTypography variant="subtitle1" marginBottom={1} fontWeight='bold'>Brand Story</StyledTypography>
        <StyledTextField
          fullWidth
          multiline
          rows={4}
